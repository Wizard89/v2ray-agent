...
hkvision=("104.16.0.0-104.16.79.255" "104.16.96.0-104.16.175.254" "104.16.192.0-104.16.207.255")
...
manageFun(){
    case $1 in
        ...
        3)
            ...
            for ((i=0;i<${#hkvision[*]};i++))
            do
                ip01=`echo ${hkvision[$i]}|awk -F "[-]" '{print $1}'`
                ip02=`echo ${hkvision[$i]}|awk -F "[-]" '{print $2}'`
                ip11=`echo $ip01|awk -F "[.]" '{print $1}'`
                ip12=`echo $ip02|awk -F "[.]" '{print $1}'`
